...
public class UsuarioService {
    ...
    public  UsuarioModel salvarUsuario(UsuarioModel usuario) {
        if(usuarioRepository.buscarPorEmail(usuario.getEmail()).isPresent())
            throw new RequestException("The email you entered has already been registered, please enter another one!");
    ...
    public UsuarioModel fazerLogin(String email, String senha){
        ...
        else throw new RequestException("Wrong credentials");
    }
    ...
    public UsuarioModel alterarTipoDeUsuario(Long codigo, String senha){
        ...
        throw  new RequestException("The password is incorrect!");
    }
    ...
    public String alterarSenha(Long codigo, String senhaAtual, String senhaNova){
        ...
        throw new RequestException("Current password ist incorrect");
    }
    ...
    public UsuarioModel isUserByCode(Long codigo){
        ...
        if(usuario.isEmpty()) throw new RequestException("User not found");
